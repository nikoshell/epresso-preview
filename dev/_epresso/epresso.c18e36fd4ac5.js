...
;
    ...
    (function() {
        ...
        /* < / > (i.e. , / .) jump to the previous / next heading, from
           wherever currentIndex() says we are — the same "current" the
        ...
        /* < / > (i.e. , / .) step through headings. The key binding itself
           lives in ShortcutsOverlay.ep, with the other global shortcuts. */
        document.addEventListener("epresso:shortcut", function(e) {
